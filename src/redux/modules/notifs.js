const NOTIF_SEND = 'pinjam/notifs/NOTIF_SEND';
const NOTIF_DISMISS = 'pinjam/notifs/NOTIF_DISMISS';
const NOTIF_CLEAR = 'pinjam/notifs/NOTIF_CLEAR';
const NOTIF_CLEAR_ALL = 'pinjam/notifs/NOTIF_CLEAR_ALL';
...
export function notifSend(notif, namespace = 'global') {
  ...
  return dispatch => {
    ...
    setTimeout(() => dispatch({ type: NOTIF_DISMISS, namespace, payload: notif.id }), notif.dismissAfter || 5000);
