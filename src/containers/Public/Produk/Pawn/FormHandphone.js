...
import iconCategory from './Assets/ic-handphone.svg';
...
export default class FormHandphone extends Component {
  ...
  handleChangeMerk = (value) => {
    ...
    setTimeout(() => {
      if (value) {
        ...
        dispatch(change('formHandphone', 'type', null));
      }
    }, 100);
  };
    ...
    return (
      <div style={style.wrap}>
        <form onSubmit={handleSubmit}>
          ...
          <Field name="capacity" component={TextField} floatingLabelText="Kapasitas Memory Internal (GB)" normalize={number} ref="capacity" withRef fullWidth />
