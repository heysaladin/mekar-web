...
import { currency } from 'utils/masking';
  ...
  handleChangeMerk = (value) => {
    ...
    setTimeout(() => {
      if (value) {
        ...
        dispatch(change('formCamera', 'type', null));
      }
    }, 100);
  };
    ...
    return (
      <div style={style.wrap}>
        <form onSubmit={handleSubmit}>
          ...
          <Field name="completeness" component={TextField} floatingLabelText="Kelengkapan Lain" hintText="Contoh: Lensa, Tripod, Monopod, Tas Kamera" ref="completeness" fullWidth multiLine rows={4} rowsMax={4} />
          <Spacer />
